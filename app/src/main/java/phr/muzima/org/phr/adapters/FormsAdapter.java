...
public class FormsAdapter extends BaseAdapter{
    ...
    public FormsAdapter(Context context,List<Form> formsList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.formNameTextView.setText(forms.get(position).getTitle());
    ...
    public class ViewHolder{
        ...
        public ViewHolder(View view){
            formNameTextView = view.findViewById(R.id.forms_title_textView);
        }
    }
}
